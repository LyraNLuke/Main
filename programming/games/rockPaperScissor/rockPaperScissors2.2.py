...
rules = tk.Label(root, text="rock beats scissors\nscissors beats paper\npaper beats rock")
rules.pack()
...
instructions = tk.Label(rpsBFrame, text="please choose your next move")
...
scissorsBtn = tk.Button(rpsBFrame, text="scissors", command=scissors)
...
resetBtn = tk.Button(root, text="reset stats", command=reset)
